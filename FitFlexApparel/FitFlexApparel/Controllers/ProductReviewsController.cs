...
namespace FitFlexApparel.Controllers
{
    public class ProductReviewsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,User_Id,Product_Id,Review,Rating,Created_At")] ProductReview productReview)
        {
            ...
            ViewBag.User_Id = new SelectList(db.AspNetUsers, "Id", "Email", productReview.User_Id);
            return View(productReview);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,User_Id,Product_Id,Review,Rating,Created_At")] ProductReview productReview)
        {
            if (ModelState.IsValid)
            {
